...
#import "JQEntryCell.h"
#import "JQDiaryEntry.h"
#import <QuartzCore/QuartzCore.h>

@interface JQEntryCell ()
...
- (void)configureCellForEntry:(JQDiaryEntry *)entry {
    ...
    if (entry.mood == JQDiaryEntryMoodGood) {
        self.moodImageView.image = [UIImage imageNamed:@"icn_happy"];
    } else if (entry.mood == JQDiaryEntryMoodAverage) {
        self.moodImageView.image = [UIImage imageNamed:@"icn_average"];
    } else if (entry.mood == JQDiaryEntryMoodBad) {
